...
export default function Header() {
  ...
  return (
    <header id="header" className="sticky top-0 z-50 px-3 sm:px-6 lg:px-8 py-2.5 sm:py-3 transition-all duration-300 pointer-events-none">
      <div className="max-w-[1440px] mx-auto bg-paper/85 backdrop-blur-xl border border-ink/10 rounded-full shadow-lg shadow-black/[0.04] hover:border-gold/30 hover:shadow-xl transition-all duration-300 px-4 sm:px-6 h-16 sm:h-[68px] flex items-center justify-between pointer-events-auto">
        {/* Brand Logo */}
        ...
        <button
          className="lg:hidden w-10 h-10 rounded-full bg-ivory border border-ink/10 flex items-center justify-center text-ink hover:text-gold transition shadow-sm"
      ...
      {open && (
        <div className="lg:hidden mt-2 max-w-[1440px] mx-auto bg-paper/95 backdrop-blur-2xl border border-ink/15 rounded-3xl p-5 shadow-2xl space-y-3 pointer-events-auto transition-all">
